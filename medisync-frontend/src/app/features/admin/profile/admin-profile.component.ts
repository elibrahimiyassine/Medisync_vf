  ...
  template: `
    ...
    <main class="page-wrapper">
      <div class="page-content">
        <h2 style="font-family:'Fraunces',Georgia,serif;margin-bottom:24px;">Mon Profil Administrateur</h2>
          ...
          <div class="glass-card" style="padding:28px;">
            ...
            <div style="display:flex;flex-direction:column;gap:14px;">
              ...
              <div>
                ...
                <span class="badge" style="background:rgba(201,99,60,0.12);color:#C9633C;border:1px solid rgba(123,97,255,0.3);">Administrateur</span>
              </div>
              <div>
                <p style="font-size:11px;color:#7A8A82;font-weight:700;text-transform:uppercase;letter-spacing:.07em;margin-bottom:4px;">Accès</p>
                <p style="font-size:14px;color:#3A5248;">Accès complet à la plateforme</p>
              </div>
            </div>
          </div>
        </div>
...
export class AdminProfileComponent {
  ...
  save(): void {
    ...
    this.api.put<any>('/admin/me', this.form.value).subscribe({
